...
import hacktohell.org.bustrcker_client.R;
...
import hacktohell.org.bustrcker_client.msgproto.msg;
import hacktohell.org.bustrcker_client.msgproto.*;
...
public class MainActivity extends FragmentActivity implements
    ...
    public void getLocation(View v) {
        ...
        if (servicesConnected()) {
            ...
            runTcpClient(data.build().toByteArray());
